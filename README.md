...
| Generic MCP server configs | `/.cline/mcp_settings.json`, `/mcp_settings.json`, `/mcp.json`, `/.mcp/mcp.json`, `/.mcp/config.json`, `/.mcp/settings.json`, `/.cursor/mcp_config.json` | `aws` (†) | `mcp-config` |
